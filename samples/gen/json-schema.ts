    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            ...
            if (data.address === undefined && (missing0 = "address")) {
                validateNestedAlternative.errors = [
                    {
                        instancePath,
                        schemaPath: "#/required",
                        keyword: "required",
    ...
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            ...
            if (
                ...
                (data.age === undefined && (missing0 = "age")) ||
                (data.nested === undefined && (missing0 = "nested"))
            ) {
                validateTop.errors = [
                    {
                        instancePath,
                    ...
                    if (data.age !== undefined) {
                        ...
                        if (errors === _errs2) {
                            if (typeof data0 == "number" && isFinite(data0)) {
                                const vSchema0 =
                                    data && data.nested1 && data.nested1.age;
                                if (
                                    vSchema0 !== undefined &&
                                    (!(
                                            ...
                                            if (errors === _errs11) {
                                                if (Array.isArray(data4)) {
                                                    ...
                                                    for (
                                                        ...
                                                        let data5 = data4[i0];
                                                        const _errs13: number =
                                                            errors;
                                                        const _errs14: number =
                                                            errors;
                                                        if (
                                                            errors === _errs14
                                                        ) {
                                                    ...
                                                    const err4 = {
                                                        instancePath:
                                                            ...
                                                            "/nested",
                                                        schemaPath:
                                                            "#/properties/nested/anyOf/1/type",
                                                        keyword: "type",
                                                        params: {
                                                            type: "array",
                                                        },
                                                ...
                                                if (errors === _errs21) {
                                                    if (Array.isArray(data7)) {
                                                        ...
                                                        for (
                                                            ...
                                                            let data8 =
                                                                data7[i1];
                                                            const _errs23: number =
                                                                errors;
                                                            const _errs24: number =
                                                                errors;
                                                            if (
                                                                errors ===
                                                                _errs24
                                                        ...
                                                        validateTop.errors = [
                                                            {
                                                                instancePath:
                                                                    ...
                                                                    "/nestedAll",
                                                                schemaPath:
                                                                    "#/properties/nestedAll/allOf/1/type",
                                                                keyword: "type",
                                                                params: {
                                                                    type: "array",
                                                                },
                                                ...
                                                if (errors === _errs32) {
                                                    if (Array.isArray(data10)) {
                                                        ...
                                                        for (
                                                            ...
                                                            let data11 =
                                                                data10[i2];
                                                            const _errs34: number =
                                                                errors;
                                                            const _errs35: number =
                                                                errors;
                                                            if (
                                                                errors ===
                                                                _errs35
                                                        ...
                                                        const err10 = {
                                                            instancePath:
                                                                ...
                                                                "/nestedOne",
                                                            schemaPath:
                                                                "#/properties/nestedOne/oneOf/1/type",
                                                            keyword: "type",
                                                            params: {
                                                                type: "array",
                                                            },
